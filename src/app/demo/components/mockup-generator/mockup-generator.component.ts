...
export class MockupGeneratorComponent implements OnInit {
  ...
  colors_base = [
    ...
    { "name": "Apple", "code": "#66B447" },
    { "name": "Butter", "code": "#FCE883" },
    { "name": "Heather", "code": "#9E7BB5" },
    { "name": "Silver", "code": "#C0C0C0" },
    { "name": "Grey Marle", "code": "#B0B0B0" },
    { "name": "Army", "code": "#4B5320" },
    { "name": "Ivory", "code": "#FFFFF0" },
    { "name": "Pepper", "code": "#504A4B" },
    { "name": "Banana", "code": "#FFE135" },
    { "name": "Bay", "code": "#0077BE" },
    { "name": "Blossom", "code": "#FFB7C5" },
    { "name": "Blue Jean", "code": "#5Dadec" },
    { "name": "Blue Spruce", "code": "#466D1D" },
    { "name": "Brick", "code": "#CB4154" },
    { "name": "Chili", "code": "#A52A2A" },
    { "name": "Citrus", "code": "#FAE700" },
    { "name": "Crimson", "code": "#DC143C" },
    { "name": "Crunchberry", "code": "#E30B5C" },
    { "name": "Cumin", "code": "#924F00" },
    { "name": "Demin", "code": "#1560BD" },
    { "name": "Granite", "code": "#676767" },
    { "name": "Grape", "code": "#6F2DA8" },
    { "name": "Graphite", "code": "#383838" },
    { "name": "Grass", "code": "#7CFC00" },
    { "name": "Grey", "code": "#808080" },
    { "name": "Hemp", "code": "#907C68" },
    { "name": "Ice Blue", "code": "#AFDCEC" },
    { "name": "Khaki", "code": "#C3B091" },
    { "name": "Light Green", "code": "#90EE90" },
    { "name": "Melon", "code": "#F7B68A" },
    { "name": "Mystic Blue", "code": "#4682B4" },
    { "name": "Periwinkle", "code": "#CCCCFF" },
    { "name": "Sandstone", "code": "#786D5F" },
    { "name": "Terracotta", "code": "#E2725B" },
    { "name": "True Navy", "code": "#3F5277" },
    { "name": "Washed Denim", "code": "#4F6D7A" },
    { "name": "Watermelon", "code": "#FC6C85" },
    { "name": "Yam", "code": "#D65076" },
    { "name": "Espresso", "code": "#61210B" },
    { "name": "Peachy", "code": "#FFDAB9" },
    { "name": "Neon Violet", "code": "#8F00FF" },
    { "name": "Burnt Orange", "code": "#CC5500" },
    { "name": "Kelly", "code": "#4CBB17" },
    { "name": "Raspberry", "code": "#E30B5D" },
    { "name": "Turquoise", "code": "#40E0D0" },
    { "name": "Vintage Hot Pink", "code": "#FF69B4" },
    { "name": "Vintage Red", "code": "#9D2933" },
    { "name": "Vintage Royal", "code": "#4169E1" },
    { "name": "Vintage Smoke", "code": "#555555" },
    { "name": "Asphalt Marle", "code": "#4D4D4D" },
    { "name": "Bright Royal", "code": "#00539C" },
    { "name": "Coal", "code": "#2D2D2D" },
    { "name": "White Marle", "code": "#F5F5F5" },
    { "name": "Texas Orange", "code": "#FF6600" },
    { "name": "Oxford Grey", "code": "#505050" },
    { "name": "Pink Candy", "code": "#FF91A4" },
    { "name": "Solid Warm Grey", "code": "#808069" },
    { "name": "Mint", "code": "#98FF98" },
    { "name": "Solid Tahiti Blue", "code": "#00CCCC" },
  ...
  ngOnInit() {
    this.type = [
      { name: 'Tshirts', code: 'tshirt', code_db: 'T-shirt' },
      { name: 'Tshirts Color', code: 'tshirt', code_db: 'T-shirt Color' },
      { name: 'Tank Tops', code: 'tanktop', code_db: 'Tank Top' },
      { name: 'Sweatshirts', code: 'sweatshirt', code_db: 'Sweatshirt' },
      { name: 'Hoodies', code: 'hoodie', code_db: 'Hoodie' },
      { name: 'Long sleeves', code: 'longsleeve', code_db: 'Long Sleeve' },
      { name: 'Crop Tee', code: 'croptee', code_db: 'Crop Tee' },
      { name: 'Racerback Tank', code: 'racerback', code_db: 'Racerback Tank' },
      { name: 'Bodysuit', code: 'bodysuit', code_db: 'Bodysuit' }
    ];
    this.categories = [
      { name: 'Men', code: 'men' },
  ...
  async onTypeChange(event: any) {
    try {
      ...
      if (selectedValue) {
        const colors_resp = await this.mockupGeneratorService.getColorsBySTyle(selectedValue.code_db)

        const filteredColors = colors_resp.colors.map((colorName: string) => {
          const match = this.colors_base.find(c => c.name === colorName);
          if (!match && !this.missingColors.includes(colorName)) {
            this.missingColors.push(colorName);  // Agregar color faltante
          }
          return match ? match : { name: colorName, code: '#FFFFFF' };
        });

        this.color = filteredColors;

        console.log('Colores faltantes:', this.missingColors);
      }
    } catch (error) {
      console.log(error);
